...
![]({{ site.baseurl }}/assets/images/292372-ecc7d290dd4d0f0f.png)
...
![]({{ site.baseurl }}/assets/images/292372-ba867bb2509c6fc4.png)
...
![]({{ site.baseurl }}/assets/images/292372-011d7fc64d176d63.png)
...
首先，我们需要告诉 Zabbix server 要与哪些 Zabbix agent 通信。所以，第一步是创建主机，如下图：
  ![]({{ site.baseurl }}/assets/images/292372-82ae4d1864e7abc7.png)
第二步，在主机列表中点击“Iterms”进行该主机的监控项设置：
  ![]({{ site.baseurl }}/assets/images/292372-6903c525459cb7a6.png)
第三步，进入创建监控项页面：
  ![]({{ site.baseurl }}/assets/images/292372-a6ab0ea028cbadb0.png)
第四步，创建监控项：
  ![]({{ site.baseurl }}/assets/images/292372-47570ec3796d857a.png)
...
![]({{ site.baseurl }}/assets/images/292372-e46c6e7f12c1716a.png)

图形化的报表：
![]({{ site.baseurl }}/assets/images/292372-7ad0297b73be9bbb.png)

有了指标数据就可以根据它进行告警了。告警在 Zabbix 中称为触发器（trigger）。如下图，我们创建了一个当 Jenkins node 小于 2 时，就触发告警的触发器：

![]({{ site.baseurl }}/assets/images/292372-dcb88e44931b70fa.png)
