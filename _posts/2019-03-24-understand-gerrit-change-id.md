...
![Gerrit workflow]({{ site.baseurl }}/assets/images/gerrit_workflow.png)
...
![]({{ site.baseurl }}/assets/images/gerrit-commit-message-with-change-id.png)
...
![]({{ site.baseurl }}/assets/images/gitlab-commit-id-issue-id-link.png)
